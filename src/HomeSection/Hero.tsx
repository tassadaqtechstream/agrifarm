          ...
          <Row>
            <Col md={8}>
              <div className="hero-content-left">
                <h1>
                  Empowering businesses and customers to source fresh, high-quality produce directly from farmers.
                  Our integrated ERP-powered marketplace ensures transparency, efficiency, and sustainability in every transaction.
                  &ldquo;The Future of Agri-Commerce, DiQa MarketPlace&rdquo;
                </h1>
                <h2 className="text-white my-5">
                  <Type />
                </h2>
                <div className="hero-footer d-flex align-items-center justify-content-between pe-4">
                  <Link to="/" className="btn btn-header btn-white">
                    Join Now
                  </Link>
                ...
                <div className="product-card">
                  <Link to="/" className="product-card-link">
                    <div className="circle-white">
                      <Image className="product__img" src={grains1} alt="Grains" width={74} height={74} />
                    </div>
                    <p>Grains</p>
                  </Link>
                  <Link to="/" className="product-card-link">
                    <div className="circle-white">
                      <Image className="product__img" src={grains2} alt="Nuts" width={74} height={74} />
                    </div>
                    <p>Nuts</p>
                  </Link>
                  <Link to="/" className="product-card-link">
                    <div className="circle-white">
                      <Image className="product__img" src={grains3} alt="Green Coffee" width={74} height={74} />
                    </div>
                    <p>Green Coffee</p>
                  </Link>
                  <Link to="/" className="product-card-link">
                    <div className="circle-white">
                      <Image className="product__img" src={grains4} alt="Olive Oil & Other Oils" width={74} height={74} />
                    </div>
